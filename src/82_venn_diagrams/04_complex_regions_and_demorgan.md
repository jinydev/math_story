---
layout: "docs"
title: '04. 복잡한 영역의 설계도와 드 모르간의 마법'
---
...
<div align="center">
  <img src="./img/04_complex_regions.svg" alt="복잡한 다이어그램 영역과 드 모르간 법칙 SVG: 3개의 원이 겹쳐진 합집합 다이어그램에서, 정중앙의 가장 교집합 되는 부분을 텅 비워 ∅(공집합)으로 만들고, 오른쪽 패널에는 괄호 안팎에서 작용하는 드 모르간의 C 폭탄(여집합 분배 시 합/교집합 부호가 뒤집히는 공식)을 직관적인 텍스트로 풀어낸 아트워크" width="800" />
</div>
