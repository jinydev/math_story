...
<div align="center">
  <img src="./img/v3_20_distance_hologram_2d.png" alt="2D 웹툰 애니 사이버펑크 스타일: 격자 무늬가 빛나는 어두운 가상 현실 훈련용 룸에서, 서로 멀리 떨어져 경계하는 두 명의 미래형 시크릿 에이전트. 그 둘의 발밑을 연결하는 네온빛 직각삼각형 뼈대가 홀로그램으로 투영되며, 피타고라스 정리에 의해 대각선 최단 거리가 실시간으로 계산되고 있는 멋진 과학적 연출" width="800" />
</div>
