...
<div align="center">
  <img src="./img/v3_10_frequency_analysis_2d.png" alt="2D 웹툰 사이버펑크 스타일: 심각한 표정의 해커가 허공에 떠 있는 홀로그램 모니터들의 암호문 데이터를 노려보고 있고, 화면 가운데 거대한 붉은 형광색 막대그래프 중 'E' 막대기가 압도적으로 치솟아있는 공격적인 빈도 분석 시스템 뷰" width="800" />
</div>
