---
layout: "docs"
title: '01. 숫자의 회전 윤회, 나머지 연산과 시저 암호'
---
...
<div align="center">
  <img src="./img/10_modulo_clock.svg" alt="모듈러 연산 시계 쳇바퀴 SVG: 10시에 5시간을 더해 12의 배수를 벗어나 3시로 도착하는 나머지 연산(% 12) 기하학적 다이어그램" width="800" />
</div>
...
<div align="center">
  <img src="./img/v3_10_caesar_wheel_2d.png" alt="2D 웹툰 사이버펑크 스타일: 허공에 떠 있는 거대한 네온 불빛의 로마 시저 암호 원판, 2개의 알파벳 링이 3칸 엇갈려 회전(Modulo 3 shift)하며 홀로그램 글자들이 튀어나오는 해킹 장면" width="800" />
</div>
