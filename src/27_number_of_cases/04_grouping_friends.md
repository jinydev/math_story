---
layout: "docs"
title: '04. 이웃하여 줄 서는 묶음Grouping 테크닉'
---
{% raw %}
...
<div align="center">
  <img src="./img/04_grouping_friends.svg" alt="이웃 순열 그룹핑SVG: A, B, C 세 명을 빨간색 테두리의 거대한 밧줄 박스로 묶어 전체 3덩어리에 대한 전역 배열(3!)을 먼저 수행하고, 하단에서는 그 1덩어리 묶음 내부에서 세 명이 자기들끼리 지지고 볶으며 자리를 교체하는 국소적 배열(3!)이 곱셈 법칙으로 누적되는 수학적 연산 흐름을 보여주는 다이어그램" width="800" />
</div>
