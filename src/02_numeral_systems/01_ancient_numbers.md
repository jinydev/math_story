---
layout: "docs"
title: '01. 첫 번째 수업 원시 시대의 수 뼛조각과 결승문자'
---
...
<div align="center">
  <img src="./img/v3_07_ishango_wolf_bone_2d.png" alt="2D 웹툰 사이버펑크 스타일: 아프리카 원시 사냥꾼이 어두운 동굴에서 빛나는 네온 조각이 새겨진 이상고 늑대 뼈를 들고 있으며, 공중에는 미래지향적인 3D 홀로그램 디지털 눈금 데이터베이스가 투사되고 있는 장면" width="800" />
</div>
...
<div align="center">
  <img src="./img/01_quipu_database.svg" alt="잉카 결승문자 밧줄 구조 SVG: 매듭의 위치와 개수를 이용하여 10진법 서버망을 구축한 고대의 하드웨어 데이터베이스 시각화" width="800" />
</div>
