...
<div align="center">
  <img src="./img/v3_64_vector_spaceship_2d.png" alt="2D 웹툰: 세련된 미래형 우주선이 3D 네온 좌표 그리드 위를 비행하며 빛나는 레이저(벡터 화살표)를 발사하고 있다. 화살표 주변에는 [크기 Magnitude] 와 [방향 Direction] 이라는 숫자가 빛나며 벡터 기하학 액션을 연출하는 씬" width="800" />
</div>
