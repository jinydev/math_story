---
layout: "docs"
title: '00. 인트로 복잡함과의 전쟁, 특수 해킹 장비들 Intro'
---
...
<div align="center">
  <img src="./img/00_polynomial_slash_python.png" alt="2D 웹툰: 사이버네틱 수학 전사가 허공에 떠 있는 X^3 - 8 글자의 홀로그램 괴수를 빛나는 에너지가 흐르는 검으로 반갈죽 해버리자 깨끗한 인수 (X-2) 박스와 (X^2+2X+4) 박스 파편 두 개로 분해되어 떨어지는 멋진 전투 씬" width="800" />
</div>
