---
layout: "docs"
title: '05. 차원이 다른 무한 칸토어의 대각선 논법'
---
...
<div align="center">
  <img src="./img/v3_21_real_number_monster_2d.png" alt="2D 웹툰 애니 사이버펑크 스타일: 고독한 해커 꼬마가 자신의 키보다 수십 배나 높은, 쏟아져 내리는 녹색과 붉은색 수소문자(실수 덩어리)의 거대한 모노리스 디지털 장벽을 마주 선 채로, 손에서 뿜어져 나오는 선명한 대각선 빛줄기 빔으로 숫자 코드들을 직접 변조하며 칸토어의 대각선 논법을 실행하는 기하학적 연출" width="800" />
</div>
...
<div align="center">
  <img src="./img/05_diagonal_hack.svg" alt="대각선 해킹 실수 논법 SVG: 상대방이 무한대로 만들었다고 주장하는 가상의 소수점 목록 리스트 위로, 좌상단에서 우하단 코너로 뻗어 나가는 해킹 라인 스캔이 1이면 2로, 그 외엔 1로 변조조작(Flip)을 가하며 완벽하게 '가장 새로운 소수점 돌연변이 X'를 바닥에 조합해 창조하는 소름 돋는 코드 실행 그래픽" width="800" />
</div>
