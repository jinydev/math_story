...
<div align="center">
  <img src="./img/02_countable_zip.svg" alt="칸토어 1:1 매핑 다이어그램 SVG: 위쪽의 [1, 2, 3...] 무한 자연수 박스들과 아래쪽의 [0, 1, -1, 2...]의 무한 정수 박스들이 어지럽게 교차하지만, 결코 꼬이지 않고 정확히 1대1로 대응되는 레이저 빔 짝짓기(Tuple Mapping) 구조" width="800" />
</div>
