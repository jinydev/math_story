...
<div align="center">
  <img src="./img/05_parabola_geometry.svg" alt="포물선과 X축 절편(근) 시각화 SVG: 파란색 포물선 궤적이 아래로 내려왔다가 올라가며 노란색 지평선(x축)을 빨간색 마커 점 두 곳에서 뚫고 지나가는, 대수학(근)과 기하학(교점)의 일치를 보여주는 좌표 차트" width="800" />
</div>
