---
layout: "docs"
title: '06. 신의 조각을 깎아 만든 스포츠 아르키메데스 다면체와 축구공'
---
...
<div align="center">
  <img src="./img/v3_12_archimedes_soccer_2d.png" alt="2D 웹툰 사이버펑크 SF 스타일: 미래적인 고글을 쓴 고대 그리스 수학자 아르키메데스가 사이버펑크 도시 배경 속에서 빛나는 하이테크 레이저 카타나(검)를 휘둘러, 공중에 떠 있는 네온 정이십면체의 모서리를 정교하게 썰자 그 덩어리가 마법처럼 현대의 흑백 가죽 축구공으로 깎여 변신하는 모습" width="800" />
</div>

<div align="center">
  <img src="./img/06_soccer_ball_archimedean.svg" alt="아디다스 텔스타 축구공 설계 원리 SVG: 왼쪽은 정이십면체의 모서리를 자르는 절단선 12개를 보여주고, 오른쪽은 그 절단 부위가 새롭게 검은색 정오각형으로 자라나 원래 피부였던 흰색 육각형들과 결합하여 현대의 축구공(준정다면체)을 완성하는 과정" width="800" />
</div>
