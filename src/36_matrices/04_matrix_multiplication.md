---
layout: "docs"
title: '04. 네 번째 수업 내적Dot 충돌 데미지 매트릭스, 행렬의 곱셈 Matrix Multiplication'
---
{% raw %}
...
<div align="center">
  <img src="./img/04_matrix_multiplication.svg" alt="앞 행렬의 가로줄(행)과 뒷 행렬의 세로줄(열)이 십자가 형태로 L자 박치기 교차 충돌을 일으키며 내적(Dot Product) 폭파 결과를 뽑아내는 악마의 규칙 SVG" width="800" />
</div>
