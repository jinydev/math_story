...
<div align="center">
  <img src="./img/04_arrow_memory.svg" alt="총과 피 암기법 (Sufficient & Necessary) SVG: 왼쪽의 p(충분조건)가 총의 총구를 겨누며 나아가는 화살표 총알을 쏘고, 오른쪽의 q(필요조건)가 그 화살에 맞아 피(필요)를 뚝뚝 흘리는 모습을 직관적이고 기억에 남게 표현한 논리 렌더링" width="800" />
</div>
