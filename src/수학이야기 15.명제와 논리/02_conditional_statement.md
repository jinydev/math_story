...
<div align="center">
  <img src="./img/02_conditional_subset.svg" alt="조건문의 스위치 변환 SVG: 집합 다이어그램과 플로우차트를 결합하여, 가정(p)이 결론(q)에 포함되는 P⊂Q 상태일 때 명제가 성립(참)하며, q의 울타리를 벗어나는 단 하나의 예외 점(반례)이 생기는 순간 명제가 붕괴(거짓)됨을 보여주는 시각화 자료" width="800" />
</div>
...
<div align="center">
  <img src="./img/v3_15_black_swan_counterexample_2d.png" alt="2D 웹툰 애니 판타지 스타일: 고대 유럽 학자의 방 안, 창밖으로 보이는 신비롭고 어두운 안개 낀 강 위를 우아하고 거대한 검은 백조(블랙스완) 한 마리가 유유히 헤엄치며 다가오자, 이를 발견한 늙고 권위 있는 철학자가 너무나도 엄청난 충격과 공포에 휩싸여 쥐고 있던 깃펜을 '툭' 하고 바닥에 떨어뜨리며 멘탈이 붕괴되는 극적인 장면" width="800" />
</div>
