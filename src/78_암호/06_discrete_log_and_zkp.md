...
<div align="center">
  <img src="./img/v3_10_zero_knowledge_cave_2d.png" alt="2D 웹툰 애니 판타지 스타일: 마법의 룬 문자가 떠다니는 도넛 모형 알리바바 동굴, 중간에 가로막힌 고대의 마법 돌문과 그 앞에 선 마법사(본인), 그리고 밖에서 무작위 선택(구경꾼 검증)을 요구하는 신비로운 증명의 오디션 장면" width="800" />
</div>
...
<div align="center">
  <img src="./img/10_zkp_logic.svg" alt="영지식 증명 확률 로지 트리 SVG: 매 검증마다 우연히 동굴을 통과할 확률(50%)이 횟수가 누적될 거듭제곱 지수 승으로 깎여나가 결국 조작 확률이 0에 수렴하는 통계학적 입증 다이어그램" width="800" />
</div>
