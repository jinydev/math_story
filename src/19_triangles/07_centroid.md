---
layout: "docs"
title: '07. 일곱 번째 수업 삼각형의 무게중심 Centroid'
---
...
<div align="center">
  <img src="./img/07_centroid_balance.svg" alt="세 개의 중선이 교차하며 2:1의 황금비율로 나뉘는 삼각형의 무게중심(G) 좌표를 기하학적으로 표현한 SVG" width="600" />
</div>
...
<div align="center">
  <img src="./img/v3_04_lesson07_3d_balance_2d.png" alt="복잡한 3D 기하학 폴리곤 덩어리가 로봇 랩실에서 가느다란 핀포인트 레이저 한 가닥 위에서 완벽히 균형(무게중심)을 잡고 있는 일러스트" width="600" />
</div>
