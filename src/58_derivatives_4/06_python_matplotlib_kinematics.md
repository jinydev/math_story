---
layout: "docs"
title: '06. 여섯 번째 수업 파이썬 Matplotlib 로켓 위치속도 3단 그래프 시각화'
---
...
<div align="center">
  <img src="./img/06_python_matplotlib_kinematics.svg" alt="파이썬 Matplotlib 라이브러리를 통해 로켓의 위치(녹색 포물선), 속도(푸른색 직선), 가속도(붉은색 직선)가 한 눈에 동기화되어 모니터에 출력되는 3단 대시보드 UI 그래픽 SVG" width="800" />
</div>
