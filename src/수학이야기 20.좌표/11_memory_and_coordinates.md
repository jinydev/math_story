...
<div align="center">
  <img src="./img/11_memory_coordinates.svg" alt="1차원 선형 RAM 구조에서 2차원 그래픽 메모리를 거쳐 3차원 AI 메모리 HBM으로 진화하는 과정을 보여주는 좌표계 SVG 애니메이션" width="800" />
</div>
...
<div align="center">
  <img src="./img/v3_20_hbm_apartment_2d.png" alt="2D 웹툰: 널찍한 평면 집(기존 메모리)과 대비되는, 실리콘 칩들을 빛의 속도로 오르내리는 사이버펑크 3D 초고층 아파트(HBM 메모리) 그래픽" width="800" />
</div>
