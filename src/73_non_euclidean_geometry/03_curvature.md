...
<div align="center">
  <img src="./img/11_curvature_types.svg" alt="가우스 곡률 3종 비교 SVG: 평탄한 유클리드 평면(K=0), 둥글게 볼록한 구면(K>0), 앞뒤/좌우 곡률이 반대인 말 안장 모양의 쌍곡면(K<0)을 수학적으로 비교하는 격자 다이어그램" width="800" />
</div>

<div align="center">
  <img src="./img/v3_11_pringles_saddle_2d.png" alt="2D 웹툰 애니 판타지 스타일: 우주 공간에 떠 있는 거대한 마법의 말 안장 곡면(쌍곡 기하학) 위에 서 있는 작은 수학자가 자를 들고 음수 곡률을 재고 있고, 바로 옆에는 완벽한 구 형태의 빛나는 농구공(양의 곡률)이 대비를 이루며 떠 있는 풍경" width="800" />
</div>
