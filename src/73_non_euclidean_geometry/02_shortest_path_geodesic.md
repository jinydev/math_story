---
layout: "docs"
title: '02. 직선의 배신 곡면 위의 최단 거리 측지선'
---
...
<div align="center">
  <img src="./img/v3_11_airplane_globe_2d.png" alt="2D 웹툰 사이버펑크 스타일: 미래적인 네온 불빛으로 빛나는 홀로그램 지구본 위를, 매끈한 사이버 비행기가 날아가며 물리적으로 똑바른 직선이 아닌 북극을 향해 둥글게 굽어지는 밝은 핑크색 궤적(측지선, 대원)을 남기는 장면" width="800" />
</div>

<div align="center">
  <img src="./img/02_geodesic_flight.svg" alt="지구본 위의 비행 항로 최단 거리 비교 SVG: 위쪽의 2D 평면 지도에서는 직선이 더 빠르고 직관적으로 보이지만, 아래쪽 구형 3D 지도에서는 위로 볼록하게 휘어진 측지선 경로가 실제 최단 거리라는 것을 증명하는 모형" width="800" />
</div>
